...
export default function SlugTopSection({data}){
    ...
    return(
        ...
        <div className='flex align-middle justify-between py-6 md:flex-row sm:flex-col xs:flex-col'>
            ...
            <p className='self-center sm:text-4xl xs:text-2xl md:text-5xl font-semibold  text-dark-blue-2'>{router.query.slug}</p>
            </div>
