    ...
    return (
        <>
            <div className="flex flex-col gap-8 w-[70%]">
              <div className="border border-gray-400 bg-gray-100 rounded-md mt-12">
                <div className="border-b p-8">
                  <h3 className="text-xl font-semibold">Project Name</h3>
                  <div className="flex flex-col gap-2 mt-4">
                    <p className="font-medium">
                      Used to identify your Project on the Dashboard, Vercel
                      CLI, and in the URL of your Deployments.
                    </p>
                ...
                <div className="border-b p-8">
                  ...
                  <div className="flex flex-col gap-2 mt-4">
                    <p className="font-medium">
                      ...
                      located. Leave this field empty if your code is not
                      located in a subdirectory. A new Deployment is required
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <label htmlFor="source">
                        Include source files outside of the Root Directory in
                        the
                      </label>
                      <p className="text-[#0073cf] flex gap-1 items-center">
                ...
                <div className="border-b p-8">
                  ...
                  <div className="flex flex-col gap-2 mt-4">
                    <p className="font-medium">
                      ...
                      Concurrent Builds, and more powerful Serverless Functions
                      by transferring your Project to a Vercel Team.
                    </p>
                  </div>
                </div>
                <div className="px-8 py-4 bg-gray-200 w-full rounded-b-md flex items-center justify-between">
                ...
                <div className="border-b p-8">
                  ...
                  <div className="flex flex-col gap-2 mt-4">
                    <p className="font-medium">
                      ...
                      deployments and domains. This action is irreversible and
                      can not be undone.
                    </p>
                  </div>
                </div>
